...
public class RequestEventHandlerFunctionHandlerTest {
    ...
    @Test
    public void testRequestEventHandlerFunctionHandler() {
        RequestEventHandlerFunctionHandler handler = new RequestEventHandlerFunctionHandler(s3Client);
