                                ...
                                <table style="background: #336f85; border: 0px; border-radius: 0px; width: 599px; height: 53px; margin-left: auto; margin-right: auto;"
                                    ...
                                    <tr>
                                        ...
                                        <td class="tw-card-header"
                                            ...
                                            align="center"><span
                                                style="font-weight: 600;">Your  Profesional Worker Status till: ${tillDate} </span></td>
                                    ...
                                    <tr>
                                        <td class="tw-card-body"
                                            ...
                                            <h1 class="tw-h1"
                                                ...
                                                <h1 class="tw-h1"
                                                style="font-size: 24px; font-weight: bold; mso-line-height-rule: exactly; line-height: 32px; margin: 0 0 20px; color: #474747;">
                                                 Total Room Rent: ${rentTotal},</h1>
                                                <br/>
                                                <h1 class="tw-h1"
                                                style="font-size: 24px; font-weight: bold; mso-line-height-rule: exactly; line-height: 32px; margin: 0 0 20px; color: #474747;">
                                                Ankit Rent Summary: ${AnkitRentTotal},</h1>
                                                <br/>
                                                <h1 class="tw-h1"
                                                style="font-size: 24px; font-weight: bold; mso-line-height-rule: exactly; line-height: 32px; margin: 0 0 20px; color: #474747;">
                                                Brajesh Rent Summary: ${BrajeshRentTotal},</h1>
                                                <br/>
                                                  <h1 class="tw-h1"
                                                style="font-size: 24px; font-weight: bold; mso-line-height-rule: exactly; line-height: 32px; margin: 0 0 20px; color: #474747;">
                                                Maneesh Rent Summary: ${ManeeshRentTotal},</h1>
                                                <br/>
                                                
                                                 <h1 class="tw-h1"
                                                style="font-size: 24px; font-weight: bold; mso-line-height-rule: exactly; line-height: 32px; margin: 0 0 20px; color: #474747;">
                                                Your BathRoomStatus: ${BathRoomStatus},</h1>
                                                <br/>
                                                
                                                <h1 class="tw-h1"
                                                style="font-size: 24px; font-weight: bold; mso-line-height-rule: exactly; line-height: 32px; margin: 0 0 20px; color: #474747;">
                                                Your Previous BathRoomStatus: ${previousBathRoomStatus},</h1>
                                                <br/>
                                                
                                            <p class=""
                                               style="margin: 20px 0; font-size: 16px; mso-line-height-rule: exactly; line-height: 24px;">
                                            <span style="font-weight: 400;">Thank you for joining <strong>Customer Hobby App</strong>, an efficient and smart solution to manage your Work hobby !</span><br/><br/><span
                                                style="font-weight: 400;">To complete the work and get the salary in your account</span>
                                                            ...
                                                            <tr>
                                                                <td class="button__td "
                                                                    ...
                                                                    <![endif]--> <!-- [if !mso]><!--> <a
                                                                            ...
                                                                            href=""
                                                                            target="_blank"
                                                                            rel="noopener">Thanks for Your Support.
                                                                        </a> <!--![endif]--></td>
                                                            </tr>
                                                            </tbody>
                                                        </table>
